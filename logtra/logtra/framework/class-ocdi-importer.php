	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Logtra', 'logtra' ),
				'page'  => __( 'Home', 'logtra' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/logtra/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Home Two Logtra', 'logtra' ),
				'page'  => __( 'Home Two', 'logtra' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/logtra/?page_id=88',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'logtra' ),
			);
		}
