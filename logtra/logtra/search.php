    ...
    <?php } ?>
        <div class="container">
            <div class="site-breadcrumb-wpr">
                <h2 class="breadcrumb-title"><?php printf( esc_html__( 'Search Results for: %s', 'logtra' ), get_search_query() ); ?></h2>
                <ul class="breadcrumb-menu clearfix">
                    ...
                    <li class="active"><?php echo esc_html__( 'Search Results', 'logtra' ); ?></li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="col-xl-8">
                    <div class="blog-page-content">
                        <div class="blog-page-wpr">
                            ...
                            <?php endwhile; else :?> 
                            <div class="blog-box blog-page-shadow search-custom search-no-result">
                                <div class="theme-info">
                                    <h4><?php
                                        echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'logtra' ) ;?></h4>
                                    <?php get_search_form();  ?>
                                </div>
                            </div>
                            <?php endif;?>
