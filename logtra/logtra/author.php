    ...
    <?php } ?>
        <div class="container">
            <div class="site-breadcrumb-wpr">
                <h2 class="breadcrumb-title"><?php the_post(); printf( esc_html__( 'All posts by %s', 'logtra' ), get_the_author() ); ?></h2>
                <ul class="breadcrumb-menu clearfix">
                    ...
                    <li class="active"><?php echo esc_html__( 'Author Posts', 'logtra' );?></li>
                </ul>
            </div>
        </div>
    </div>
