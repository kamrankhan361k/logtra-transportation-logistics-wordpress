    ...
    <?php } ?>
        <div class="container">
            <div class="site-breadcrumb-wpr">
                <h2 class="breadcrumb-title"><?php printf( esc_html__( 'Category Archives: %s', 'logtra' ), single_cat_title( '', false ) ); ?></h2>
                <ul class="breadcrumb-menu clearfix">
                    ...
                    <li class="active"><?php echo esc_html__( 'Category', 'logtra' ); ?></li>
                </ul>
            </div>
        </div>
    </div>
